...
values (1, 1, 'VIP', 'RECEIVED', 100, CURRENT_TIMESTAMP(), 100, CURRENT_TIMESTAMP);

insert into delivery (delivery_id, restaurant_id, customer_type, delivery_status, current_distance_from_destination_in_metres,
                      expected_delivery_time, time_to_reach_destination_in_seconds, created_at)
values (2, 1, 'VIP', 'PREPARING', 100, CURRENT_TIMESTAMP(), 100, CURRENT_TIMESTAMP);

insert into delivery (delivery_id, restaurant_id, customer_type, delivery_status, current_distance_from_destination_in_metres,
                      expected_delivery_time, time_to_reach_destination_in_seconds, created_at)
values (3, 1, 'VIP', 'PICKED_UP', 100, CURRENT_TIMESTAMP(), 100, CURRENT_TIMESTAMP);

insert into delivery (delivery_id, restaurant_id, customer_type, delivery_status, current_distance_from_destination_in_metres,
                      expected_delivery_time, time_to_reach_destination_in_seconds, created_at)
values (4, 1, 'VIP', 'DELIVERED', 100, CURRENT_TIMESTAMP(), 100, CURRENT_TIMESTAMP);
